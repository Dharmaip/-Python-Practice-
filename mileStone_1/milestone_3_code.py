...
print("There will be 15 questions you have to answer and we'll be keep in track on your score. Let's start!")
...
answer = input().lower()
attempts = 0
while answer not in ["sahara", "Sahara", "sahara desert", "Sahara desert", "Sahara Desert"] and attempts < 2:
    print("Incorrect! Please try again.")
    answer = input().lower()
    attempts += 1
...
answer = input().lower()
attempts = 0
while answer not in ["nile", "Nile" and attempts < 2]:
    print("Incorrect! Please try again.")
    answer = input().lower()
    attempts += 1
...
answer = input().lower()
attempts = 0
while answer not in ["rome", "Rome"] and attempts < 2:
    print("Incorrect! Please try again.")
    answer = input().lower()
    attempts += 1
...
while answer not in ["madrid", "Madrid"] and attempts < 2:
    print("Incorrect! Please try again.")
    print("Hint: It is also known for its famous football club.")
    answer = input().lower()
    attempts += 1
...
print("Congratulations! You have completed the quiz game. Your total score is {} out of 15.".format(score))
